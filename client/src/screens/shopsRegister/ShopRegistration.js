    ...
    return (
        <div>
            <Dialog fullWidth maxWidth="md" open={open} onClose={handleClose}>
                <DialogContent>
                <Typography align="center" variant="h6">Shop Details</Typography>
                            ...
                            <Grid item  container  xs={3} direction={'row'} justifyContent='center' alignItems='center'>
                                ...
                                <Grid item mt={1} mb={1}>
                                    <label htmlFor="contained-button-file">
                                        <Input accept="image/*" type='file' id="contained-button-file" multiple={true} onChange={(e)=>uploadImage(e)} />
